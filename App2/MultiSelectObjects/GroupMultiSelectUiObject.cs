...
{
    public class GroupMultiSelectUiObject : MultiSelectUiObjectBase
    {
        public float CanvasRight { get; set; }
        public float CanvasBottom { get; set; }
        public GroupMultiSelectUiObject() : base()
        {
        }
        public override ObservableCollection<string> CommandSource => new ObservableCollection<string> { "Group", "Duplicate", "Delete", "Hide" };
