...
namespace App2.SpritesTransformViews
{
    ...
    /// </summary>
    public sealed partial class TransformSprite : Canvas
    {
        ...
        {
            get { return (UiObject)GetValue(ViewModelProperty); }
            set { SetValue(ViewModelProperty, value); }
        }

        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register("ViewModel", typeof(UiObject), typeof(TransformSprite), new PropertyMetadata(0));
        ...
        private void Move_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
            ...
            ViewModel.MiddlePoint = new Point(ViewModel.Width / 2 + ViewModel.CanvasLeft, ViewModel.Height / 2 + ViewModel.CanvasTop);
        }
        ...
        private void Rotate_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
            ...
            var rotationDelta = AngleBetweenTwoLines(center, start, center, point);
            if (MultiSelectionHub.Instance.CurrentMultiSelection == null)
                ViewModel.Rotation -= (float)rotationDelta;
            else
                MultiSelectionHub.Instance.CurrentMultiSelection.Rotation -= (float)rotationDelta;
        }
